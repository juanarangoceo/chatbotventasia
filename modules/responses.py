...
def obtener_respuesta(mensaje, cliente_id):
    ...
    if cliente_id not in usuarios:
        ...
        return (
            ...
            "Te ayudaré con la **Cafetera Espresso Pro**.\n\n"
    ...
    if "cara" in mensaje or "muy costosa" in mensaje:
        return (
            ...
            "Pero la **Cafetera Espresso Pro** es una inversión: "
            "ahorras dinero y disfrutas café de alta calidad todos los días. ☕✨\n\n"
            "📦 **¿Quieres que te ayude a procesar tu pedido?**"
        )
    ...
    if estado == "verificar_datos" and mensaje in ["sí", "si", "correcto"]:
        ...
        return (
            "🎉 **¡Pedido confirmado!** En las próximas horas recibirás "
            "un mensaje con la información de envío. **¡Gracias por tu compra!** ☕🚀"
        )
