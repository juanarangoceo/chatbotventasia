...
from modules.responses import obtener_respuesta  # Asegúrate de que el nombre coincida con responses.py
...
def whatsapp():
    ...
    response_text = obtener_respuesta(incoming_msg, sender)  # Aquí está la corrección
